...
cp tool_test/voc2012/psp_test.sh tool_test/voc2012/test_voc_psp.py ${config} ${exp_dir}
...
$PYTHON -u tool_test/voc2012/test_voc_psp.py \
  --config=${config} --attack_name ${attack_name} --attack_iterations ${attack_iterations} --attack_epsilon ${attack_epsilon} --attack_alpha ${attack_alpha} --attack \
