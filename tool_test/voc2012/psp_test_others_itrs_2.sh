...
cp tool_test/voc2012/psp_test_ddcat.sh tool_test/voc2012/test_voc_psp.py ${config} ${exp_dir}

export PYTHONPATH=./

CUDA_VISIBLE_DEVICES=${gpu_id} $PYTHON -u tool_test/voc2012/test_voc_psp.py \
