...
CUDA_VISIBLE_DEVICES=2 $PYTHON -u tool_test/voc2012/test_voc_psp_ddcat.py \
  --config=${config} --attack --gpu_id 2 --attack_name ${attack_name} --attack_iterations ${attack_iterations} --attack_epsilon ${attack_epsilon} --attack_alpha ${attack_alpha} \
